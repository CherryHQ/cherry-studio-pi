export enum IpcChannel {
  ...
  DataSync_ExternalSyncCompleted = 'data-sync:external-sync-completed',
  DataSync_LocalStorageV2Changed = 'data-sync:local-storage-v2-changed',
  ...
  StorageV2_GetLegacyRuntimePolicies = 'storage-v2:get-legacy-runtime-policies',
  StorageV2_GetSensitiveLegacyProjectionCleanupPlan = 'storage-v2:get-sensitive-legacy-projection-cleanup-plan',
  StorageV2_CleanupSensitiveLegacyProjections = 'storage-v2:cleanup-sensitive-legacy-projections',

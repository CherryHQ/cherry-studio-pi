    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          model: { type: 'string', description: 'Required model id in provider::model format' },
          plan_model: { type: 'string', description: 'Optional planning model id in provider::model format' },
          planModel: { type: 'string', description: 'Alias for plan_model' },
          small_model: { type: 'string', description: 'Optional small model id in provider::model format' },
          smallModel: { type: 'string', description: 'Alias for small_model' },

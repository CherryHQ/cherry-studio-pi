...
import type { LegacyPaintingsState } from '@renderer/store/paintings'
...
import type { SelectionState } from '@renderer/store/selectionStore'
...
type StorageV2CoreSnapshot = {
  ...
  redux?: {
    ...
    paintings?: Partial<LegacyPaintingsState>

...
const GITHUB_REPO = 'CherryHQ/cherry-studio-pi'
const GITCODE_REPO = 'CherryHQ/cherry-studio-pi'
...
const GITCODE_LATEST_FALLBACK = `https://github.com/${GITHUB_REPO}/releases/latest/download`

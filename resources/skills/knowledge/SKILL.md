---
name: knowledge
description: Perry Studio 知识库 CLI。用户想查看知识库、搜索知识库内容、定位知识库配置或用知识库资料回答问题时使用。
tags:
  - perry-studio
  - knowledge
  - rag
...
Use `perry-knowledge` to inspect and search the user's configured Perry Studio knowledge bases.

...
//
// Cherry Studio Pi's agent runtime packages also need to be bundled because they are
// executed from the main process and include ESM surfaces that are safer inlined.
